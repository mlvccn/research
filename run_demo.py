...
parser.add_argument('--layers', '-l', type=int, default=152)
parser.add_argument('--weight_name', '-w', type=str, default='RTFNet152') # RTFNet_152, RTFNet_50, please change the number of layers in the network file
parser.add_argument('--file_name', '-f', type=str, default='final_152.pth')
...
if __name__ == '__main__':
    ...
    # model.load_state_dict(pretrained_weight) # For MFNet final.pth
