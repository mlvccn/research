...
from add.updater import DynamicAttentiveAdaptation
...
class MultimodalTransformer(nn.Module):
    ...
    def forward(self, vid_embeds, vid_pad_mask, text_queries, obj_queries):
        ...
        # TODO: introduce temporal
        # vid_embeds, txt_memory = self.daa(vid_embeds,  repeat(txt_memory, 's b c -> t b s c', t=t))

        txt_memory = repeat(txt_memory, 's b c -> s (t b) c', t=t)
        # txt_memory = rearrange(txt_memory, 't b s c -> s (t b) c')
