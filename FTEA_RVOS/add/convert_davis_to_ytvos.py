...
ROOT_PTAH = "/data16t/data/DAVIS/ref-davis"
"""
ytvos structure
- train
    - Annotations
...
def read_split_set(data_root=ROOT_PTAH):
...
def mv_images_to_folder(data_root=ROOT_PTAH, output_root='data/ref-davis'):
...
def create_meta_expressions(data_root=ROOT_PTAH, output_root='data/ref-davis'):
    """
...
def create_meta_annotaions(data_root=ROOT_PTAH, output_root='data/ref-davis'):
    """
